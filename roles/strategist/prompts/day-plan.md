...
| 6 | `inbox/fleeting-notes.md` и очереди | Мини-триаж: только действия сегодня, срочные сигналы и решения пилота | Короткий Inbox Triage без архивации |
...
6. **Inbox Triage** (если нужно):
   - Просмотреть свежие заметки и вынести только то, что меняет план сегодня, угрожает остановкой работы или требует решения пилота.
   - Каждую вынесенную заметку связать с источником.
   - Остальное не классифицировать, не помечать и не архивировать: полный разбор делает Note-Review в 23:00.
