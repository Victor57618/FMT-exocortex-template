...
Источник сценария: /c/Users/tocpeople/IWE/PACK-digital-platform/pack/digital-platform/02-domain-entities/DP.ROLE.012-strategist/scenarios/scheduled/03-week-review.md

## Контекст

- **WeekPlan:** /c/Users/tocpeople/IWE/DS-strategy/current/WeekPlan W*.md
- **Шаблон:** /c/Users/tocpeople/IWE/PACK-digital-platform/pack/digital-platform/02-domain-entities/DP.ROLE.012-strategist/templates/reviews/weekly-review.md
...
```bash
# Для КАЖДОГО репо в /c/Users/tocpeople/IWE/:
git -C /c/Users/tocpeople/IWE/<repo> log --since="last monday 00:00" --until="today 00:00" --oneline --no-merges
```

- Пройди по ВСЕМ репозиториям в `/c/Users/tocpeople/IWE/`
...
1. Переключись на **роль Автора (R4)** и на основе секции «Итоги W{N}» в WeekPlan сформируй пост для клуба.
   ...
   **Обязательно прочитай** `/c/Users/tocpeople/IWE/DS-Knowledge-Index/CLAUDE.md` — полные инструкции роли Автора:
...
2. Создай файл `/c/Users/tocpeople/IWE/DS-Knowledge-Index/docs/{YYYY}/{YYYY-MM-DD}-week-review-w{N}.md`
...
4. Обнови `/c/Users/tocpeople/IWE/DS-Knowledge-Index/docs/README.md` — добавь строку в начало текущего месяца
...
```markdown
**Пост итогов W{N-1}:** [название](https://github.com/Victor57618/DS-Knowledge-Index/blob/main/docs/{YYYY}/{YYYY-MM-DD}-week-review-w{N-1}.md) — status: ready → авто-публикация Пн 07:14
```
