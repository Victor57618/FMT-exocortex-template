...
Локальные изменения русского представления FPF (`Readme-ru.md`, `Readme-ru.docx`) не отправлять в `ailev/FPF`. Синхронизировать их только локально; отсутствие push-доступа и неопубликованный локальный коммит с этими файлами не считать блокировкой или сигналом «Требует внимания».
