...
Каждое новое upstream-обновление FPF в `origin/main` обязательно сообщать пилоту в разделе «Требует внимания» с числом новых коммитов. Локальные изменения русского представления FPF (`Readme-ru.md`, `Readme-ru.docx`) не отправлять в `ailev/FPF`: синхронизировать их только локально, а отсутствие push-доступа и неопубликованный локальный коммит только с этими файлами не считать блокировкой или отдельным сигналом внимания.
