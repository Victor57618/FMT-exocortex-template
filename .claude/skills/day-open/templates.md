...
> **Если есть прошедшие мини-триаж** → таблица ниже. Остальные заметки остаются Note-Review и в следующий DayPlan автоматически не переносятся.

| Заметка | Почему нужна сегодня | Решение / действие | ✅ |
|---------|----------------------|--------------------|---|
| [«текст»](путь#L1) | меняет план / угроза остановки / решение пилота | → что сделать | [ ] |
