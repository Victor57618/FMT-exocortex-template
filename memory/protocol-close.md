...
for repo in $(ls /c/Users/tocpeople/IWE/); do
  if [ -d /c/Users/tocpeople/IWE/$repo/.git ]; then
    commits=$(git -C /c/Users/tocpeople/IWE/$repo log --since="today 00:00" --oneline --no-merges 2>/dev/null)
...
/c/Users/tocpeople/IWE/DS-IT-systems/DS-ai-systems/synchronizer/scripts/day-close.sh
```
